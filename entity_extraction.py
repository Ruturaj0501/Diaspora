...
def main():
    ...
    try:
        ...
        print("[ERROR] extracted_data.json not found. Run Phase 1 first.")
        return
    ...
    with open("phase2_output.json", "w", encoding="utf-8") as f:
    ...
    print("[SUCCESS] Output saved to phase2_output.json")
